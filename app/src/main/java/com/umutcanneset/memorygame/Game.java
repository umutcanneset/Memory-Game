    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(Game.this, MainPage.class);
        ...
        point1 = (EditText) findViewById(R.id.points1);
        point2 = (EditText) findViewById(R.id.points2);

        pointText1.setEnabled(false);
        pointText2.setEnabled(false);
    ...
    private void calculate() {
        ...
        if(firstCard==secondCard){
            ...
            if(turn==1){
                ...
                ppoint2+=1;
                point2.setText(String.valueOf(ppoint2));

                MediaPlayer match2= MediaPlayer.create(this,R.raw.definite);
                match2.start();
            }
        }else{
